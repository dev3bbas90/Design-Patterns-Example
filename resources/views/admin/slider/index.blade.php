...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            ...
            <h3 class="card-label">{{__('Slider')}}</h3>
        </div>
            ...
            <tbody>
               @foreach($sliders as $slider)
                <tr>
                    ...
                    <td><img src="{{$slider->path}}" width="70px" style="border-radius: 10px;"></td>
                    <td>{{$slider->alt}}</td>
                    <td>{{$slider->url}}</td>

                    <td>
                        <a href="{{route('slider.edit',$slider)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
