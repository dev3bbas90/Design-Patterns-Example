...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            ...
            <h3 class="card-label">{{__('Show Times')}}</h3>
        </div>
        <div class="card-toolbar">

            <!--begin::Button-->
            <a href="{{route('hall_time_frames.create')}}" class="btn btn-primary font-weight-bolder">
        ...
        <table class="table  table-head-custom table-checkable" id="kt_datatable1">
            ...
            <tbody>
               @foreach($time_frames as $time_frame)
                <tr>
                    <td>{{$time_frame->id}}</td>
                    <td>{{$time_frame->hall->theater->name}}</td>
                    <td>{{$time_frame->hall->code}}</td>
                    <td>{{$time_frame->from}}</td>
                    <td>{{$time_frame->to}}</td>
                  
                    <td>
                        <a href="{{route('hall_time_frames.edit',$time_frame)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
