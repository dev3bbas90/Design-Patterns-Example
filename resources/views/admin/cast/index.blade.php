...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            ...
            <h3 class="card-label">{{__('Cast')}}</h3>
        </div>
        <div class="card-toolbar">

            <!--begin::Button-->
            <a href="{{route('casts.create')}}" class="btn btn-primary font-weight-bolder">
            ...
            <tbody>
               @foreach($casts as $cast)
                <tr>
                    ...
                    <td><img src="{{$cast->path}}" width="70px" style="border-radius: 10px;"></td>

                    <td>
                        <a href="{{route('casts.edit',$cast)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
