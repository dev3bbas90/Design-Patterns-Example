...
<div class="card card-custom">
    <div class="card-header py-3">
        <div class="card-title">
            ...
            <h3 class="card-label">{{__('Partners')}}</h3>
        </div>
        ...
        <table class="table  table-head-custom table-checkable" id="kt_datatable1">
            ...
            <tbody>
               @foreach($partners as $partner)
                <tr>
                    <td>{{$partner->id}}</td>
                    <td><img src="{{$partner->path}}" width="70px" style="border-radius: 10px;"></td>
                    <td>{{$partner->alt}}</td>
                    <td>
                        <a href="{{route('partners.edit',$partner)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
