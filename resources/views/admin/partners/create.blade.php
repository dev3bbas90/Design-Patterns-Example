        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="" method="post" enctype="multipart/form-data" action="{{route('partners.store')}}">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <label>{{__('Alt')}} </label>
                                    <input type="text" class="form-control" required placeholder="{{__('Partner alt')}}" value="{{old('alt')}}" name="alt"  />
                                    @error('alt')
