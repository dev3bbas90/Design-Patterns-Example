        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="" method="post" enctype="multipart/form-data" action="{{route('events.store')}}">
                        @csrf
                        <div class="card-body">
                            <div class=" row">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <select required class="form-control get_times" id='halls' required name="hall_id">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="date" class="form-control get_times" required placeholder="{{__('From Date')}}" id="from_date" name="from_date" />
                                    @error('from_date')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                     @enderror
                                </div>
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="date" class="form-control get_times" required placeholder="{{__('To Date')}}" id="to_date" name="to_date" />
                                    @error('to_date')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                     @enderror
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="number" step="0.01" class="form-control" required placeholder="{{__('Weekend Price')}}" name="weekend_price" />
                                    @error('weekend_price')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                     @enderror
                                </div>
