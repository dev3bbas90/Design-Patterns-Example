            ...
            <tbody>
               @foreach($categories as $category)
                <tr>
                    <td>{{$category->id}}</td>
                    <td>{{$category->name}}</td>
                    <td>{{$category->price_raise}} %</td>
                    <td><div style="background-color: {{$category->color}}; width:20px;height:20px"></div></td>
                    <td>{{$category->code}}</td>
                   
                    <td>
                        <a href="{{route('categories.edit',$category)}}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
