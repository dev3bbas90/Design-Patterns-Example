        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form method="post" enctype="multipart/form-data"   action="{{route('halls.update',$hall)}}">
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 form-group ">
                                    <label>{{__('Code')}} </label>
                                    <input type="text" id="code" class="form-control" required placeholder="{{__('Hall Code')}}" value="{{$hall->code}}" name="code"  />
                                    @error('code')
                                ...
                                <div class="col-lg-6 form-group ">
                                    ...
                                    <select class="form-control select2" name="theater_id" id="theater_id" required>
                                        @foreach ($theaters as $theater)
                                            <option @if($theater->id == $hall->theater_id) selected @endif value="{{$theater->id}}">{{$theater->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('theater_id')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                ...
                                <div class="col-lg-6 form-group ">
                                    ...
                                    <input type="number" class="form-control" id="rows_no" required placeholder="{{__('Rows Number')}}" value="{{$hall->rows_no}}" name="rows_no" id="rows_no" />
                                    @error('rows_no')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-lg-6 form-group ">
                                    ...
                                    <input type="number" id="cols_no" class="form-control" required placeholder="{{__('Number Of Columns Per Row')}}" value="{{$hall->cols_no}}" name="cols_no" id="cols_no"  />
                                    @error('cols_no')
                                        <span class="form-text" style="color:red">{{ $message }}</span>
                                    @enderror
                                </div>
